...
r/01_funct_DataCleaning.R: Contains the functions to clean raw data (e.g., moving averages, categorize temperatures).
r/02_funct_DataProcessing.R: Contains functions to process cleaned data (e.g., moving averages, categorize temperatures).
r/03_funct_Plots.R: Contains functions to visualize global temperature data (`plot_global_temp()`, `plot_temp_moving_average()`).
...
rmd/12_DataProcessing.Rmd: RMarkdown file that processes cleaned data, adds new variables, saves processed data and generates plots.
FinalReport.Rmd: Draft of the project report including title, abstract, introduction, data description, preliminary visualization, and analysis.
...
5. Knit 'rmd/12_DataProcessing.Rmd' to process the cleaned data and generate outputs.
...
[https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/global/time-series/globe/land_ocean/tavg/12/0/1880-2025](https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/global/time-series/globe/land_ocean/tavg/12/0/1880-2025)
